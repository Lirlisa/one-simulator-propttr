 ...
 */
public class MaxPropRouterWithTTR extends ActiveRouter {
    /** Router's setting namespace ({@value})*/
	public static final String MAXPROP_NS = "MaxPropRouterWithTTR";
	/**
	 ...
	 */
	public MaxPropRouterWithTTR(Settings settings) {
		super(settings);
	 ...
	 */
	protected MaxPropRouterWithTTR(MaxPropRouterWithTTR r) {
		super(r);
		this.alpha = r.alpha;
	...
	public void changedConnection(Connection con) {
		...
		if (con.isUp()) { // new connection
			...
			if (con.isInitiator(getHost())) {
				...
				assert mRouter instanceof MaxPropRouterWithTTR : "MaxProp only works "+ 
				" with other routers of same type";
				MaxPropRouterWithTTR otherRouter = (MaxPropRouterWithTTR)mRouter;
	...
	private Tuple<Message, Connection> tryOtherMessages() {
		...
		for (Connection con : getConnections()) {
			...
			MaxPropRouterWithTTR othRouter = (MaxPropRouterWithTTR)other.getRouter();
	...
	public MessageRouter replicate() {
		MaxPropRouterWithTTR r = new MaxPropRouterWithTTR(this);
		return r;
	}
